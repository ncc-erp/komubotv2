...
// import { Client, ActionRowBuilder, ButtonBuilder, EmbedBuilder} from "discord.js";
...
//         const userdb = await this.komubotrestService.findUserData(req.body.username) ;
//         if (!userdb) {
...
//         // store to db
//         try {
//             this.data = this.komubotrestService.insertDataToWFH(userid, req.body.message, false, false, 'ACTIVE');   
//         }catch (err){
...
//         await this.sendMessageToChannel(client, req, res);
//       }
//       sendMessageKomuToUser = async (client, msg) => {
//         await client.channels.cache
